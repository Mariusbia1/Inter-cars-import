...
export const MissionSection = () => {
  const points = [
    {
      title: 'Accès direct aux stocks d’exception',
      description: 'Connexion directe avec les concessions officielles et réseaux agréés Porsche, Ferrari, Audi Sport et Mercedes-AMG.'
    },
    {
      title: 'Audit physique intransigeant en 150 points',
      description: 'Châssis, historisation constructeur, diagnostic électronique et mesure ultrasonique de carrosserie.'
    },
    {
      title: 'Transparence tarifaire absolue',
      description: 'Zéro commission cachée, facturation directe concession et tarification claire de notre honoraire de conciergerie.'
    }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border border-gold/40">
              <img
                ...
                alt="Audit d'un véhicule de sport Inter Cars Import"
              ...
              <div className="absolute bottom-6 left-6 right-6 p-5 rounded-xl bg-rolex-dark/95 backdrop-blur-md border border-gold/40 text-white">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-serif font-bold text-sm text-gold">Curateur Automobile Indépendant</h4>
                    <p className="text-xs text-slate-300">Nous défendons exclusivement vos intérêts, sans aucun compromis.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            <SectionHeader
              align="left"
              badge="Notre Mission"
              title="Démocratiser l'Excellence Automobile Européenne"
              subtitle="Inter Cars Import est né d'une conviction profonde : acquérir un véhicule de prestige doit être une expérience exaltante, sereine et économiquement avantageuse."
              className="mb-6"
            />
